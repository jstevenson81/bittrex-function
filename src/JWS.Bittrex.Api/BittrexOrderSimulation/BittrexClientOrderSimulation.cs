...
using JWS.Bittrex.Api.Domain;

namespace JWS.Bittrex.Api.BittrexOrderSimulation
{
    /// <summary>
    /// Behaves exactly like Bittrex, except that buy and sell orders are not put through to Bittrex, and are simulated instead
    /// </summary>
    public class BittrexClientOrderSimulation : BittrexClient
    {
        ...
        public BittrexClientOrderSimulation(string apiKey, string apiSecret) : base(apiKey, apiSecret)
        {
        }
